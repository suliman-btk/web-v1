<?php
/**
 * Seller: list / search / delete products.
...
<div class="admin-toolbar">
    <form method="get" action="<?= e(url('seller/products.php')) ?>">
        <input type="search" name="q" value="<?= e($q) ?>" placeholder="Search products...">
        <button class="btn btn-ghost btn-sm" type="submit">Search</button>
        <?php if ($q !== ''): ?><a class="btn btn-ghost btn-sm" href="<?= e(url('seller/products.php')) ?>">Clear</a><?php endif; ?>
    </form>
    <a class="btn btn-primary" href="<?= e(url('seller/product_form.php')) ?>">➕ Add New Product</a>
</div>
    ...
    <table class="data">
        ...
        <?php else: foreach ($products as $p): ?>
            <tr>
                ...
                <td class="actions">
                    <a class="btn btn-outline btn-sm" href="<?= e(url('seller/product_form.php?id=' . (int)$p['product_id'])) ?>">Edit</a>
                    <form class="inline-form" method="post" action="<?= e(url('seller/products.php')) ?>"
